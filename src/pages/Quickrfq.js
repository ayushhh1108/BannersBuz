            ...
            <div className="container">
                ...
                <div className="my-5">
                    ...
                    <div className="d-flex align-items-center my-4">
                        <span className='me-4 col-2'>Print Sides</span>
                        <div className="col-4 d-flex">
                            <Form.Control type="text" placeholder="Enter name" />
                        </div>
                    </div>
                    <div className="d-flex align-items-center my-4">
                        <span className='me-4 col-2'>Material Weight	</span>
                        <div className="col-4 d-flex">
                            <Form.Control type="text" placeholder="Enter name" />
                        </div>
                    </div>
                    <div className="d-flex align-items-center my-4">
                        <span className='me-4 col-2'>Lamination</span>
                        <div className="col-4 d-flex">
                            <Form.Control type="text" placeholder="Enter name" />
                        </div>
                    </div>
                    <div className="d-flex align-items-center my-4">
                        <span className='me-4 col-2'>Pantone + Color Bridge Coated (optional)</span>
                        <div className="col-4 d-flex">
                            <Form.Control
                    ...
                    <div className="d-flex align-items-center my-4">
                        <span className='me-4 col-2'>Add Accessories (optional)	</span>
                        <div className="col-4 d-flex">
                            <Form.Control
                                type="text" className='me-2'
                                id="inputPassword5"
                    ...
                    <div className="d-flex py-5 align-items-center flex-wrap">
                        ...
                        <div className="col-3"> Shipping and tax amount will be calculated at the Cart.
                        </div>
                    ...
                    <div className="text-center">
                        <button className="btn btn-primary mx-2">Done Cart it</button>
                        <button className="btn btn-outline-primary mx-2">Mail this quotation</button>
                        <button className="btn btn-outline-primary mx-2">Done Cart it</button>
                    </div>
