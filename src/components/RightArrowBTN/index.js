...
const RightArrowbtn = ({ text }) => {
  return (
    <a
      href="#"
      className="d-flex card-title align-items-center px-3 py-2 justify-content-around w-fit-content text-light bg-blue-btn"
    >
...
const OrangeButton = ({ text }) => {
  return (
    <Button
      variant="outline-primary bg-orange border-0 text-light shop-now-btn"
