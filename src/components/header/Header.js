    ...
    <header>
      <div className="topbar d-flex justify-content-between">
        ...
        <div className="topbar_right d-flex font-size-13 right-sideheader w-46">
          ...
          <Link to="" className="text-muted">
            {" "}
            <img src={account} alt="account" className="profile-png" /> Hi, Vraj
          </Link>
      ...
      <div className="main_wrapper">
        ...
        <div className="search-select-box d-flex align-items-center">
          <CreatableSelect
            components={{ DropdownIndicator:() => <img src={searchIcon} className="pr-3"/>, IndicatorSeparator:() => null }}
            styles={{
              control: (baseStyles) => ({
                ...baseStyles,
      ...
      <div className="main-navbar d-flex navbar-color justify-content-around">
